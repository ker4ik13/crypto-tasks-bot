...
const getChannelPreviewString = (
  ...
  return `${channel.isActive ? emojis.available : emojis.unavailable} ${channel.channelName} • ${emojis.bagOfMoney} ${channel.reward} ${currency} • ${emojis.peoples} ${channel._count.subsUsers} `;
};
